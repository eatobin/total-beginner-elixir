...
defmodule BorrowerTest do
  ...
  test "set a new name and maxBooks" do
    assert Borrower.set_name("Borrower1",
      %Borrower{name: "Jack", max_books: 1}) == @br1
    assert Borrower.set_max_books(1,
      %Borrower{name: "Borrower1", max_books: 11}) == @br1
  end

  test ~s/return a string \"Borrower1 (1 books)\"/ do
